...
const STEPS = [
  {
    icon: Store,
    title: "Browse Stores",
    description: "Start by exploring local stores near you. We have groceries, pharmacies, restaurants, and more!",
    action: "Let's go to Stores",
    path: "/stores",
  },
  {
    icon: ShoppingCart,
    ...
    <Dialog open={open} onOpenChange={() => {}}>
      ...
      >
        ...
        <div className="bg-gradient-to-br from-primary/20 to-primary/5 p-6 pb-10 text-center relative">
          ...
          />
          <h2 className="font-outfit font-bold text-xl">Welcome to Carry Bee!</h2>
