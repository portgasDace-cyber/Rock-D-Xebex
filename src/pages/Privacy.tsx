...
const Privacy = () => {
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <h2 className="text-2xl font-bold mb-2">Security Precautions</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold mb-2">Data Deletion and Retention</h2>
            <p className="mb-4">
